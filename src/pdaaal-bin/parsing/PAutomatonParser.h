...
namespace pdaaal {
    ...
    public:
        ...
        PAutomaton<W,trace_info_type> get_p_automaton() {
        ...
        void finish_atom() {
            ...
            PAutomaton<W,trace_info_type> new_p_automaton(_pda, _current_nfa, _states);
    ...
    private:
        ...
        std::optional<PAutomaton<W,trace_info_type>> _current_p_automaton;

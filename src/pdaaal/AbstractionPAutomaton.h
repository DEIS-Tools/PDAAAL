...
namespace pdaaal {
    ...
    template <typename T, typename AT, typename W = void, typename C = std::less<W>, typename A = add<W>>
    ...
    public:
        ...
        AbstractionPAutomaton(const AbstractionPDA<T,AT,W,C>& pda, const NFA<T>& nfa, const std::vector<size_t>& states)
